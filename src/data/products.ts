...
/**
 * The catalogue the site renders: the local base, the CMS over it, and two
 * overlays on top.
 *
 * The overlays are both keyed by product id and both there for the same
 * reason — they carry curation that lives in this repo rather than in the CMS,
 * and a wholesale CMS override would otherwise drop it:
 *
