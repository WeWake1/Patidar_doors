...
/*
 * reactbits StrokeText, ported to TS. The registry copy verbatim otherwise —
 * font-family is inherited, so the caller styles it from CSS (see
 * `.doorwall__title` in global.css). Lazy-load this component: gsap +
 * ScrollTrigger are ~35 KB gzipped and nothing above the fold needs them.
 */
